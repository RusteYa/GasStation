                ...
                <ul class="menu-list">
                    ...
                    <li class="dropdown default-dropdown"><a class="dropdown-toggle" data-toggle="dropdown"
                        ...
                        <ul class="custom-menu">
                            ...
                            <li><a href="products.ftl">Products</a></li>
                            <li><a href="product-page.ftl">Product Details</a></li>
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center">
                ...
                <div class="footer-copyright">
                    ...
                    2018 All rights reserved | This template is made with <i class="fa fa-heart-o"
