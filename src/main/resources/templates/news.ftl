...
<div class="container">
    <#if user?? && (user.appRole.name == "ROLE_CONTENTMANAGER" || user.appRole.name == "ROLE_MANAGER")>
        <div class="row" style="margin-bottom: 10px">
            ...
            <div class="col-md-4">
                <a href="/contentmanager/news/add" class="btn btn-primary btn-lg">Добавить новую новость</a>
            </div>
            <div class="col-md-4"></div>
        </div>
    </#if>
    ...
    <div class="row">
        ...
        <#if user?? && (user.appRole.name == "ROLE_CONTENTMANAGER" || user.appRole.name == "ROLE_MANAGER")>
            <div class="col-md-1">
                <a href="/contentmanager/news/${news.id}/" class="btn btn-primary btn-sm crud_btn">Изменить</a>
